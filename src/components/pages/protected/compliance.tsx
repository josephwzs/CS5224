...
export default function CompliancePage() {
  ...
  const [siteFrameworks, setSiteFrameworks] = useState({
    site_id: "",
    frameworks: [],
  });
  ...
  useEffect(() => {
    Promise.all([
      amplifyApi.get<{ frameworks: any[] }>("BackendApi", "/frameworks"),
      amplifyApi.get<{ site_id: string; frameworks: any[] }>(
        "BackendApi",
        "/site_frameworks"
      ),
      amplifyApi.get<{ alerts: any[] }>("BackendApi", "/alerts"),
      amplifyApi.get("BackendApi", "/thresholds"),
    ]).then(([frameworks, site_frameworks, alerts, thresholds]) => {
      setFrameworks({ frameworks: frameworks });
      setSiteFrameworks({
        site_id: site_frameworks.site_id,
        frameworks: site_frameworks.frameworks,
      });
      setAlerts({ alerts: alerts });
      setThresholds({
        site_id: thresholds.site_id,
        framework_code: thresholds.framework_code,
          ...
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <CardDescription>
                  Choose the Fite to configure compliance settings
                </CardDescription>
              </div>
            </div>
          </CardHeader>
            ...
            <CardHeader>
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <CardDescription>
                    Select the sustainability standard and target certification
                    level
                  </CardDescription>
                </div>
              </div>
                ...
                {selectedStandard === "bca-green-mark" && (
                  <div className="space-y-3">
                    ...
                    <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-4">
                      {certificationLevels["bca-green-mark"].map((level) => (
                        <button
                          key={level.level}
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <CardDescription>
                    ...
                    {selectedLevelInfo?.displayName} certification - adjust as
                    needed
                  </CardDescription>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  <div className="rounded-lg border bg-card p-4">
                    ...
                    <div className="space-y-2">
                      ...
                      />
                      <p className="text-xs text-muted-foreground">
                        Industry benchmark for energy efficiency in data centers
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="rounded-lg border bg-card p-4">
                    ...
                    <div className="space-y-2">
                      ...
                      />
                      <p className="text-xs text-muted-foreground">
                        Measures water consumption efficiency in liters per kWh
                      </p>
                    </div>
                  </div>
            ...
            <CardHeader>
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <CardDescription>
                    Review and save your compliance configuration with adjusted
                    thresholds
                  </CardDescription>
                </div>
              </div>
